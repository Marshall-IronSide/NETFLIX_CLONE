...
const Navbar = () => {
    ...
    return (
        <nav className="bg-black text-gray-200 flex justify-between items-center p-4 h-20 text-sm md: text-[15px] front-medium text-nowrap">
            <Link to={"/"}>
                <img src={Logo} alt="Logo" className="w-24 cursor-pointer brightness-125"></img>
            </Link>
            ...
            <div className="flex items-center space-x-4 relative">
                ...
                {!user ? (<Link to={"/signin"}>
                    ...
                    <img src={avatarUrl} alt="Avatar" className="w-10 h-10 rounded-full border-2 border-[#e50914] cursor-pointer " onClick={() => setShowMenu(!showMenu)} />
